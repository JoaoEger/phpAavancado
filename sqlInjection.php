<?php
//sql injection sao formas de inserir comandos sql por entradas no software
//$_GET
//$_POST
/**
...
if(isset($_POST['usuario'])){
    ...
    // $usuario = preg_replace('/[^a-zA-ZO-9]/', '', $_POST['usuario']);
    // $senha = preg_replace('/[^a-zA-ZO-9]/', '', $_POST['senha']);
